...
export class NoteParser {
	...
	async parseActiveNote(zoteroKeyField: string, sectionNames: string[]): Promise<ParsedNote> {
	...
	private extractSections(body: string, sectionNames: string[]): Record<string, string> {
